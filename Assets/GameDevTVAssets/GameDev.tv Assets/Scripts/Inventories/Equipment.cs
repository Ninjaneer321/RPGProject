...
namespace GameDevTV.Inventories
{
    ...
    public class Equipment : MonoBehaviour, ISaveable, IPredicateEvaluator
    {
        ...
        private void Start()
        {
            ...
            //Use TraitStore event to make sure my traits and stats are updated correctly when using equipment.
            //Currently putting them on works. Taking items off leaves the bonuses intact - it shouldn't.
        }
        /// <summary>
